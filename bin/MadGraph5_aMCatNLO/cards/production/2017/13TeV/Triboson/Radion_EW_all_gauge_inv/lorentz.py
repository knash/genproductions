...
VVS3 = Lorentz(name = 'VVS3',
               spins = [ 3, 3, 1 ],
               structure = 'P(1,1)*P(2,1) + P(1,3)*P(2,1) - P(-1,1)**2*Metric(1,2) - P(-1,1)*P(-1,3)*Metric(1,2)')

VVS4 = Lorentz(name = 'VVS4',
               spins = [ 3, 3, 1 ],
               structure = 'P(1,2)*P(2,2) + P(1,2)*P(2,3) - P(-1,2)**2*Metric(1,2) - P(-1,2)*P(-1,3)*Metric(1,2)')
...
VVVS3 = Lorentz(name = 'VVVS3',
                spins = [ 3, 3, 3, 1 ],
                structure = 'P(3,1)*Metric(1,2) + P(3,3)*Metric(1,2) + P(3,4)*Metric(1,2) - P(1,1)*Metric(2,3) - P(1,3)*Metric(2,3) - P(1,4)*Metric(2,3)')
